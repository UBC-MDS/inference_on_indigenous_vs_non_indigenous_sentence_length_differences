...
We had a large enough sample size to apply a permutation test as the total sample size was `r format(counts$Count[1] + counts$Count[2])`. We carried out the permutation test with `r N_REPEATS` under the null hypothesis, computing and comparing the median for each of the two groups.
